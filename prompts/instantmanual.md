...
Use create-instant-app to scaffold a new Instant project
...
Once you complete the prompts  and add your app ID to the .env file:
...
Found m@instantdb/reactm in your package.json.
Found mNEXT_PUBLIC_INSTANT_APP_IDm: *****
Planning schema...
The following changes will be applied to your production schema:
mADD ENTITYm profiles.id
mADD ENTITYm posts.id
mADD ENTITYm comments.id
mADD ENTITYm tags.id
mADD ATTRm profiles.nickname :: unique=false, indexed=false
mADD ATTRm profiles.createdAt :: unique=false, indexed=false
mADD ATTRm posts.title :: unique=false, indexed=false
mADD ATTRm posts.slug :: unique=true, indexed=false
mADD ATTRm posts.body :: unique=false, indexed=false
mADD ATTRm posts.createdAt :: unique=false, indexed=true
mADD ATTRm comments.body :: unique=false, indexed=false
mADD ATTRm comments.createdAt :: unique=false, indexed=false
mADD ATTRm tags.title :: unique=false, indexed=false
mADD LINKm posts.author <=> profiles.authoredPosts
mADD LINKm comments.post <=> posts.comments
mADD LINKm comments.author <=> profiles.authoredComments
mADD LINKm posts.tags <=> tags.posts
mADD LINKm profiles.$user <=> $users.profile
m?m OK to proceed?m myes
mSchema updated!m
```
...
m+  }m
m+}m
OK to proceed?m myesm
mPermissions updated!m
```
...
Let your users try your app before creating an account
